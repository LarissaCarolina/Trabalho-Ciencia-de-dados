...
## Dados do Mundo
   ...
   A leitura dos dados foi feita utilizando a função *read_csv* do pacote ***readr*, como argumento utilizamos a url que já vínhamos utilizando durante as aulas práticas para trabalhar com esses dados.
   ...
   Dessa forma, foi necessário primeiro alterar o formato de cada uma das bases, passando essas para o formato 'arrumado' (*tidy*), neste cada variável é uma coluna e as linhas são os valores observados para as mesmas. Isso foi feito utilizando a função *pivot_longer* do pacote **tidyverse**.
