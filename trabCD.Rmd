...
# Introdução
  ...
  A partir deste trabalho iremos fornecer uma visão sobre o panorama da doença atualmente. O produto final será um painel desenvolvido em shiny que trará análises descritivas visuais e métricas de interesse sobre o momento atual da pandemia no mundo e no Brasil.
